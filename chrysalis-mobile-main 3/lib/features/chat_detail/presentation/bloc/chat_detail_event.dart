...
// Event for updating a single message status (message:all_delivered)
class SingleMessageStatusUpdatedEvent extends ChatDetailEvent {
  const SingleMessageStatusUpdatedEvent({
    required this.messageId,
...
/// Event to initialize chat - handles crypto and socket work in background
class InitializeChatEvent extends ChatDetailEvent {
  ...
  @override
  List<Object?> get props => [type, id, isGroup, encryptedGroupKey, page, limit];
}
...
class LoadChatMessagesEvent extends ChatDetailEvent {
  ...
  @override
  List<Object?> get props => [type, id, decryptGroupKey, page, limit];
}
