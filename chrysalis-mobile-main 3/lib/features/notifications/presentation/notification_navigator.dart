...
class NotificationNavigator {
  static Future<void> handleNotificationNavigation(
    ...
    log('Notification received with data: $data');
    
    final route = data['route'];
    log('Navigation route: $route');
    ...
    if (route == 'chat_detail') {
      try {
        ...
        log('Failed to decrypt group key or navigate to chat: $e');
        // Navigate to home page on any error
