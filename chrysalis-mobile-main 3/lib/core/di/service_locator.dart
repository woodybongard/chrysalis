...
Future<void> initServiceLocator() async {
  sl
    ...
    ..registerLazySingleton<GetRecentSearchesUseCase>(
      () => GetRecentSearchesUseCase(sl<SearchGroupRepository>()),
    )
    ..registerLazySingleton<SearchUseCase>(
      () => SearchUseCase(sl<SearchGroupRepository>()),
    )
    ..registerLazySingleton<AddToRecentSearchUseCase>(
      () => AddToRecentSearchUseCase(sl<SearchGroupRepository>()),
    )
    // Homepage Feature
